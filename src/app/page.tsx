        ...
        <div className="relative w-[90%] md:w-[75%] mt-3 p-6 overflow-hidden border border-[#333333] rounded bg-white">
          ...
          <div className="relative z-20 text-[#333333]">
            ...
            <div className="text-base md:text-lg leading-relaxed">
              I made this site because I like sudoku. It's just that I happen to like my sudoku puzzles to be like my ice cream: plain. Like good ol' fashioned vanilla.
              <br />
              <a
                href="https://www.youtube.com/watch?v=MeQ6Wjz-9zo&ab_channel=VanillaSudoku"
                target="_blank"
                rel="noopener noreferrer"
                className="group block relative mt-4 w-full aspect-video overflow-hidden rounded border border-[#333333]"
              >
                <img
